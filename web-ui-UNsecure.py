#!/usr/bin/env python3
"""
The unsecure version of the simple Modbus TCP traffic light dashboard.
Unsecure part:
- No SSL/TLS (HTTP only)
- Information leakage via error messages
- Possible way to bypass login by manipulating cookies/session
...
def write_on_off():
    try:
        # print('raw:',request,json.get("flag") , request.is_json)
